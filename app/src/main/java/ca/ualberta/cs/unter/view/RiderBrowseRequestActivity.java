...
//                startActivity(intentRiderBrowseRequest);
    ...
    public void onStart() {
        super.onStart();
        inProgressRequestAdapter = new ArrayAdapter<>(this, R.layout.driver_accepted_list_item, inProgressRequestList);
        completedRequestAdapter = new ArrayAdapter<>(this, R.layout.driver_pending_list_item, completedRequestList);
